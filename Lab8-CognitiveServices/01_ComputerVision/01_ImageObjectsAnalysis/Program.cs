...
static class Program
{
    ...
    // this region.
    // Endpoint z Portal → Keys and Endpoint (u nových resource ne vždy funguje regionální *.api.cognitive.microsoft.com)
    const string uriBase = "https://cloudappdev26-cv.cognitiveservices.azure.com/vision/v2.0/analyze";
